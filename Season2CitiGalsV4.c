...
#pragma config(Motor,  port4,           turbine1,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           turbine2,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           turbine3,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           ballShootLeft, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           ballShootRight, tmotorVex393_MC29, openLoop)
